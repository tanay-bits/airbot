...
const float magn_ellipsoid_center[3] = {117.287, 34.2423, -84.7709};
const float magn_ellipsoid_transform[3][3] = {{0.802571, 0.0249058, 0.0207550}, {0.0249058, 0.815268, 0.0106748}, {0.0207550, 0.0106748, 0.996845}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
#define GYRO_AVERAGE_OFFSET_X ((float) -47.6)
#define GYRO_AVERAGE_OFFSET_Y ((float) 81.29)
